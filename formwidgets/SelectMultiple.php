<?php namespace MarlonFreire\MercadoLibre\FormWidgets;
 ...
 */
class SelectMultiple extends FormWidgetBase
{
     ...
     * @inheritDoc
     */
    protected $defaultAlias = 'SelectMultiple';
    ...
    public function getLoadValue()
    {
        ...
        if($this->getFieldOptions() && $this->fieldName === "categorias"){
            $selected = Categoria::getSelected();
            return $selected;
        }
